  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-4 pt-4 sm:px-6 sm:pt-5">
      <div className="relative flex w-full max-w-4xl items-center">
        ...
        <div
          className={`absolute -left-2 top-1/2 -translate-y-1/2 transition-all duration-500 sm:-left-4 ${view !== 'hero'
        ...
        <nav
          id="navbar-pill"
          className={`mx-auto flex items-center gap-1 rounded-full border border-leaf-light/30 bg-leaf-nav/80 px-2 py-2 shadow-lg backdrop-blur-md transition-all duration-500 sm:gap-2 sm:px-4 ${view !== 'hero' ? 'translate-x-4 sm:translate-x-8' : ''
            }`}
        >
          <button
            onClick={() => onNavigate('about')}
            className={`rounded-full px-3 py-1.5 text-xs font-semibold tracking-wider transition-all duration-300 sm:px-4 sm:text-sm ${view === 'about'
          ...
          <button
            ...
            className={`rounded-full px-3 py-1.5 text-xs font-semibold tracking-wider transition-all duration-300 sm:px-4 sm:text-sm ${view === 'contact'
                ? 'bg-leaf-light/30 text-gold'
                : 'text-gold/80 hover:bg-leaf-light/30 hover:text-gold'
              }`}
          >
          ...
          <button
            onClick={() => onNavigate('hero')}
            className={`rounded-full px-3 py-1.5 text-xs font-semibold tracking-wider transition-all duration-300 sm:px-4 sm:text-sm ${view === 'hero'
                ? 'bg-leaf-light/30 text-gold'
                : 'text-gold/80 hover:bg-leaf-light/30 hover:text-gold'
              }`}
          >
          ...
          <button
            ...
            id="nav-signup-btn"
            className={`rounded-full px-3 py-1.5 text-xs font-semibold tracking-wider transition-all duration-300 sm:px-4 sm:text-sm ${view === 'signup'
